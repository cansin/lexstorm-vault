export default function PrivacyPolicyPage() {
  return (
    <>
      ...
      <h2>Introduction</h2>
      <p>
        Welcome to LexStorm Vault. This Privacy Policy explains how we collect,
      ...
      <p>
        While using LexStorm Vault, we may ask you to provide us with certain
      ...
      <p>
        ...
        collect information. You can instruct your browser to refuse all cookies
